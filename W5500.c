...
unsigned char Rx_Buffer[BUFFER_MAX_SIZE];	 
unsigned char Tx_Buffer[BUFFER_MAX_SIZE];	 
...
IntDispose:
	...
	if( (S0_Mode==TCP_CLIENT) && (Read_W5500_SOCK_2Byte(0, Sn_DPORTR)!= S0_DPort[0]*256+S0_DPort[1]) )
	{
